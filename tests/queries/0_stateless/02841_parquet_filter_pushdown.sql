...
select count(), sum(number) from file('02841.parquet') where indexHint(dt64_s between '-2.01e8'::Decimal64(0) and 1.5e8::Decimal64(0));
select count(), sum(number) from file('02841.parquet') where indexHint(dt64_cs between '-2.01e8'::Decimal64(1) and 1.5e8::Decimal64(2));
